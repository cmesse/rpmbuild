...
%else
%if "%{tpls_libs}" == "static"
BLAS_LIBRARIES=%{tpls_blas_static} LDFLAGS="%{tpls_prefix}/lib/libcblas.a {tpls_prefix}/lib/lblas.a" python3 configure.py
%else
LD_LIBRARY_PATH="%{tpls_prefix}/lib" LDFLAGS="-L%{tpls_prefix}/lib -Wl,-rpath,%{tpls_prefix} -lcblas -lblas" BLAS_LIBRARIES=%{tpls_blas_shared} python3 configure.py
%endif
%endif
