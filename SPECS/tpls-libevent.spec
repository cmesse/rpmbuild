...
%define tpls_flavor skylake-gnu-mpich-debug 
...
# important paths
%define tpls_prefix /opt/tpls/skylake-gnu-mpich-debug 
%define tpls_includes /opt/tpls/skylake-gnu-mpich-debug/includes 
%define tpls_libdir /opt/tpls/skylake-gnu-mpich-debug/lib 
...
%define tpls_ld_library_path  /opt/tpls/skylake-gnu-mpich-debug/lib 
...
# MPI wrappers
%define tpls_mpicc   /opt/tpls/skylake-gnu-mpich-debug/bin/mpicc
%define tpls_mpicxx  /opt/tpls/skylake-gnu-mpich-debug/bin/mpicxx 
%define tpls_mpifort /opt/tpls/skylake-gnu-mpich-debug/bin/mpifort 
%define tpls_mpiroot /opt/tpls/skylake-gnu-mpich-debug 
%define tpls_mpilib /opt/tpls/skylake-gnu-mpich-debug/lib/libmpi.so 

# Compiler Flags
%define tpls_cflags    -O2 -m64 -fno-fast-math -fPIC -mtune=skylake -m64 -I/opt/tpls/skylake-gnu-mpich-debug/include
%define tpls_cxxflags  -O2 -m64 -fno-fast-math -fPIC -mtune=skylake -m64 -I/opt/tpls/skylake-gnu-mpich-debug/include
%define tpls_fcflags   -O2 -m64 -fno-fast-math -fPIC -mtune=skylake -m64 -I/opt/tpls/skylake-gnu-mpich-debug/include
%define tpls_ldflags    -L/opt/tpls/skylake-gnu-mpich-debug/lib  -Wl,-rpath,/opt/tpls/skylake-gnu-mpich-debug/lib
%define tpls_arflags   -cru
%define tpls_ompflag    -fopenmp

# the netlib reference implementations
%define tpls_blas   /opt/tpls/skylake-gnu-mpich-debug/lib/libblas.so
%define tpls_lapack  /opt/tpls/skylake-gnu-mpich-debug/lib/liblapack.so
%define tpls_scalapack /opt/tpls/skylake-gnu-mpich-debug/lib/libscalapack.so
...
%define tpls_arpack /opt/tpls/skylake-gnu-mpich-debug/lib/libarpack.so
%define tpls_parpack /opt/tpls/skylake-gnu-mpich-debug/lib/libparpack.so
%define tpls_superlu /opt/tpls/skylake-gnu-mpich-debug/lib/libsuperlu.so
%define tpls_metis /opt/tpls/skylake-gnu-mpich-debug/lib/libmetis.so
