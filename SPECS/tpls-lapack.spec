...
%files
%{tpls_prefix}/%{tpls_libdir}/cmake/lapack-%{version}/lapack-config-version.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapack-%{version}/lapack-config.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapack-%{version}/lapack-targets-release.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapack-%{version}/lapack-targets.cmake
%if "%{tpls_libs}" == "static"
%{tpls_prefix}/%{tpls_libdir}/liblapack.a
%else
%{tpls_prefix}/%{tpls_libdir}/liblapack.so
%{tpls_prefix}/%{tpls_libdir}/liblapack.so.3
%{tpls_prefix}/%{tpls_libdir}/liblapack.so.%{version}
%endif
%{tpls_prefix}/%{tpls_libdir}/pkgconfig/lapack.pc
%{tpls_prefix}/%{tpls_libdir}/libtmglib.so
%{tpls_prefix}/%{tpls_libdir}/libtmglib.so.3
%{tpls_prefix}/%{tpls_libdir}/libtmglib.so.%{version}

%files -n tpls-%{tpls_flavor}-blas
%if "%{tpls_libs}" == "static"
%{tpls_prefix}/%{tpls_libdir}/libblas.a
%else
%{tpls_prefix}/%{tpls_libdir}/libblas.so
%{tpls_prefix}/%{tpls_libdir}/libblas.so.3
%{tpls_prefix}/%{tpls_libdir}/libblas.so.%{version}
%endif
%{tpls_prefix}/%{tpls_libdir}/pkgconfig/blas.pc
...
%{tpls_prefix}/%{tpls_libdir}/cmake/cblas-%{version}/cblas-config-version.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/cblas-%{version}/cblas-config.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/cblas-%{version}/cblas-targets-release.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/cblas-%{version}/cblas-targets.cmake
%if "%{tpls_libs}" == "static"
%{tpls_prefix}/%{tpls_libdir}/libcblas.a
%else
%{tpls_prefix}/%{tpls_libdir}/libcblas.so
%{tpls_prefix}/%{tpls_libdir}/libcblas.so.3
%{tpls_prefix}/%{tpls_libdir}/libcblas.so.%{version}
%endif
%{tpls_prefix}/%{tpls_libdir}/pkgconfig/cblas.pc
...
%{tpls_prefix}/%{tpls_libdir}/cmake/lapacke-%{version}/lapacke-config-version.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapacke-%{version}/lapacke-config.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapacke-%{version}/lapacke-targets-release.cmake
%{tpls_prefix}/%{tpls_libdir}/cmake/lapacke-%{version}/lapacke-targets.cmake
%if "%{tpls_libs}" == "static"
%{tpls_prefix}/%{tpls_libdir}/liblapacke.a
%else
%{tpls_prefix}/%{tpls_libdir}/liblapacke.so
%{tpls_prefix}/%{tpls_libdir}/liblapacke.so.3
%{tpls_prefix}/%{tpls_libdir}/liblapacke.so.%{version}
%endif
%{tpls_prefix}/%{tpls_libdir}/pkgconfig/lapacke.pc
